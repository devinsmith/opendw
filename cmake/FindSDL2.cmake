...
FIND_LIBRARY(SDL2_LIBRARY NAMES SDL2 PATH_SUFFIXES lib ${CMAKE_SOURCE_DIR}/deps/sdl2/lib/${VC_LIB_PATH_SUFFIX})
IF(SDL2_LIBRARY)
...
IF(WIN32)
  ...
  ENDIF(MINGW)
  FIND_LIBRARY(SDL2_MAIN_LIBRARY NAMES SDL2main PATH_SUFFIXES lib ${CMAKE_SOURCE_DIR}/deps/sdl2/lib/${VC_LIB_PATH_SUFFIX})
